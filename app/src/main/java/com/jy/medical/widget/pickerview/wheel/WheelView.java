...
package com.jy.medical.widget.pickerview.wheel;
...
import com.jy.medical.widget.pickerview.adapters.WheelViewAdapter;
import com.jy.medical.widget.pickerview.config.DefaultConfig;
...
//        mPaintRectCenter.setColor(DefaultConfig.COLOR);
        mPaintRectCenter.setColor(Color.parseColor("#3282F0"));
...
//        mPaintLineCenter.setColor(config.mThemeColor);
        mPaintLineCenter.setColor(Color.parseColor("#3282F0"));
