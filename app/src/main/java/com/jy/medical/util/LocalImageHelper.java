...
public class LocalImageHelper {
    ...
    private final MedicalApplication context;
    ...
    public String setCameraImgPath() {
        String foloder= MedicalApplication.getInstance().getCachePath()
                + "/PostPicture/";
    ...
    private LocalImageHelper(MedicalApplication context) {
    ...
    public static void init(MedicalApplication context) {
