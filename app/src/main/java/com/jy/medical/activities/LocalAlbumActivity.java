...
//                            camera.setVisibility(View.VISIBLE);
    ...
    View.OnClickListener onClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            if(LocalImageHelper.getInstance().getCurrentSize()+LocalImageHelper.getInstance().getCheckedItems().size()>=100){
                Toast.makeText(LocalAlbumActivity.this,"最多选择100张图片", Toast.LENGTH_SHORT).show();
                return;
            }
